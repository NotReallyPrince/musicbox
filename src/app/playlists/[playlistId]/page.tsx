...
import { faList, faPlay, faPlus, faShuffle, faTrashCan } from "@fortawesome/free-solid-svg-icons"
...
export default function Playlist() {
  ...
  const enqueuePlaylist = async () => {
    ...
    if (roomConnected && mode === 'broadcast' && !isHost) {
      message.error(`You cannot enqueue your playlist in broadcast room`)
      setLoading(false)
      return
    }
    dispatch(setPlayer({
